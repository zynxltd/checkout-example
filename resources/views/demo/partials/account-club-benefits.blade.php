...
@if (! empty($club['benefits']))
    @if (! empty($club_page))
        <section
            class="demo-account-club-benefits demo-account-club-benefits--club-page{{ ! empty($compact) ? ' demo-account-club-benefits--compact' : '' }}"
            aria-labelledby="club-benefits-title"
        >
            <div class="demo-account-club-benefits__intro">
                <img
                    ...
                    loading="eager"
                >
                <div class="demo-account-club-benefits__copy">
            ...
            <div class="demo-account-club-benefits__tiers" role="list">
    ...
    @else
        <section
            class="demo-account-club-benefits{{ ! empty($horizontal) ? ' demo-account-club-benefits--horizontal' : '' }}{{ ! empty($compact) ? ' demo-account-club-benefits--compact' : '' }}"
            aria-labelledby="club-benefits-title"
        >
