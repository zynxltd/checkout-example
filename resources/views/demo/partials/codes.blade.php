...
<div class="yg-codes" id="yg-codes">
    ...
    <div class="yg-code-row yg-code-row--set">
        <span class="yg-code-row__text">Offer <strong>{{ $cart['offer_code'] }} - £{{ number_format($cart['offer_discount'], 2) }} OFF</strong></span>
    ...
    <div class="yg-codes__offer">
        ...
        <p class="yg-code-field__hint" id="yg-offer-hint">Only 1 offer code per order. Demo: try <strong>TEST</strong> for £5.50 off.</p>
    </div>
    @endif
</div>
